...
export function normaliseJob(job, index = 0) {
  ...
  return {
    ...
    customer: billToParty,
    billToParty,
    payToParty: job.payToParty || '',
    notifyParty: job.notifyParty || '',
    goodsDescription: job.goodsDescription || '',
    marksNumbers: job.marksNumbers || '',
    hsCode: job.hsCode || '',
    containerQty: safeNumber(job.containerQty, 0),
    containerType: job.containerType || '',
    netWeightKgs: safeNumber(job.netWeightKgs, 0),
    grossWeightKgs: safeNumber(job.grossWeightKgs, 0),
    cbmM3: safeNumber(job.cbmM3, 0),
    currency,
    defaultFxRate,
